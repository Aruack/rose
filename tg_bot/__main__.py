...
Join my [Update channel](https://t.me/Aruackofficial) to get information on all the latest updates.
"""
...
""".format(dispatcher.bot.first_name, "" if not ALLOW_EXCL else "If you have any bugs or questions on how to use me, have a look at my [Group](https://t.me/cfc_bot_support), or head to @Aruackofficial.")

DONATE_STRING = """Heya, glad to hear you want to donate!
There are two ways of paying him; [PayPal](paypal.me/paymentech)."""
...
def start(bot: Bot, update: Update, args: List[str]):
    if update.effective_chat.type == "private":
        ...
        update.effective_message.reply_text("Hello all Join @Aruackofficial.")
